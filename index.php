	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI EKONOMI MASYARAKAT</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SIEM </span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=data-kecamatan" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Kecamatan</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-desa" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Desa</p>
									</a>
								</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				//kecamatan
				case 'data-kecamatan':
					include "admin/kota/kecamatan/data_kecamatan.php";
					break;
				case 'add-kecamatan':
					include "admin/kota/kecamatan/add_kecamatan.php";
					break;
				case 'edit-kecamatan':
					include "admin/kota/kecamatan/edit_kecamatan.php";
					break;
				case 'anggota':
					include "admin/kota/kecamatan/anggota.php";
					break;
				case 'del-anggota':
					include "admin/kota/kecamatan/del_anggota.php";
					break;
				case 'del-kecamatan':
					include "admin/kota/kecamatan/del_kecamatan.php";
					break;

				//desa
				case 'data-desa':
					include "admin/kota/desa/data_desa.php";
					break;
				case 'add-desa':
					include "admin/kota/desa/add_desa.php";
					break;
				case 'edit-desa':
					include "admin/kota/desa/edit_desa.php";
					break;
				case 'anggota':
					include "admin/kota/desa/anggota.php";
					break;
				case 'del-anggota':
					include "admin/kota/desa/del_anggota.php";
					break;
				case 'del-desa':
					include "admin/kota/desa/del_desa.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/vadhiell_/">
					<strong> SIEM</strong>
				</a>
				All rights reserved.
			</div>
